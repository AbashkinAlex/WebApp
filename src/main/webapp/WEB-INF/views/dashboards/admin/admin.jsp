                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="/adminDash/update" method="post">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select path="cityList" name="cityId" class="form-control">
                                                    <option value="">Select to Edit(УДАЛИТЬ)</option>
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <h4 class="title">${myUserData.firstName}<br/>
                                        <small>${myUserData.lastName}</small>
                                    </h4>
